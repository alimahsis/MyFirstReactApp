            ...
            <>
                <div className="row" style={{direction: 'ltr'}}>
                    <div className="col-sm">
                        <TempInput id="dolar" type="$" placeholder="مقدار به دلار" value={dolar} onChange={this.handleChange}></TempInput>
                    </div>
                    <div className="col-sm">
                        <TempInput id="toman" type="تومان" placeholder="مقدار به تومان" value={toman} onChange={this.handleChange}></TempInput>
                    </div>
                </div>
            </>
        )
