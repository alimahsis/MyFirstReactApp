...
class ErrorPage extends Component {
    state = {
        ...
        description: "این صفحه زمانی به نمایش در می آید که در روند اجرای دستورات خطایی رخ دهد",
        errorText: ""
    };
        ...
        return (
            <>
                <main className="container" style={{ direction: "rtl" }}>
                    ...
                    <div className="alert alert-danger text-right p-4" role="alert">
                        <p className="mb-0 text-center font-weight-lighter">{this.state.errorText}</p>
                    </div>
