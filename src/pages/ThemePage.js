                ...
                <div className="card text-right">
                    ...
                    <div className="card-body">
                        <blockquote className="blockquote mb-0">
                                    ...
                                    <Form>
                                        <Form.Row>
                                            <Form.Group as={Col} md="6" controlId="validationCustom01">
                                                <Form.Label>پس زمینه</Form.Label>
                                            ...
                                            <Form.Group as={Col} md="6" controlId="validationCustom02">
                                                ...
                                                <FormControl
                                                    as="select"
                                                    name="variantMenu"
                                                    value={theme.variantMenu}
                                                    onChange={changeTheme}
                                                >
                                                    <option value="dark">روشن</option>
                                                    <option value="light">تاریک</option>
                                                </FormControl>
                                            </Form.Group>
                                        </Form.Row>
                                    </Form>
                            ...
                            <footer className="blockquote-footer text-left lead">منو را ویرایش کنید</footer>
                        </blockquote>
                    </div>
                </div>
            </>
